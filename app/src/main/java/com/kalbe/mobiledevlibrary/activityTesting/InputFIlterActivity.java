...
public class InputFIlterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputFilters.etTextWatcher(editText, 5);
        ...
        InputFilters.etCapsTextWatcher(editText1, 5);
        ...
        char[] chars = {',','.'};
        InputFilters.etTextWatcherSPChar(editText2, 5, chars);
        ...
        InputFilters.etCapsTextWatcherSPChar(editText3, 5, chars);
        ...
        InputFilters.etCapsTextWatcherNoSpace(editText4, 5, chars);
        ...
        InputFilters.etTextWatcherNoSpaceAtFirst(editText5, 5, chars);
        ...
        InputFilters.etCapsTextWatcherNoSpaceAtFirst(editText6, 5, chars);
    }
